...
def addPortal(portal):
	...
	li = xbmcgui.ListItem(portal['name'], iconImage='special://home/addons/pulgin.video.stealthplus/fanart.jpg')
...
def genreLevel():
	...
	li = xbmcgui.ListItem('SELECT A TV CATEGORY FROM BELOW', iconImage='special://home/addons/plugin.video.stealthplus/fanart.jpg')
	...
	for id, i in data.iteritems():
		...
		if id == '68':
			iconImage = 'special://home/addons/plugin.video.stealthplus/adult.jpg';
		else:
			iconImage = 'special://home/addons/plugin.video.stealthplus/fanart.jpg';
...
def vodLevel():
	...
	for i in data:
		...
		if logo != '':
			...
			logo_url = 'special://home/addons/plugin.video.stealthplus/fanart.jpg';
...
def channelLevel():
	...
	try:
		...
		xbmcgui.Dialog().notification(Wrong, str, xbmcgui.NOTIFICATION_ERROR );
		return;
		...
		for i in data.values():
			...
			if genre_id_main == genre_id or genre_id_main == '*':
				...
				if logo != '':
					...
					logo_url = 'special://home/addons/plugin.video.stealthpremium/fanart.jpg';
...
def playLevel():
	...
	li = xbmcgui.ListItem(title, iconImage='special://home/addons/plugin.video.stealthplus/fanart.jpg', thumbnailImage=logo_url);
