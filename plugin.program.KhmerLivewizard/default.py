...
ADDON=xbmcaddon.Addon(id='plugin.program.KhmerLivewizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.1"
PATH = "KhmerLivewizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://archive.org/download/wizards/wizards.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("KhmerLive Wizard","Downloading ",'', 'Please Wait')
